 ...
 * @author tienp
 */
@WebServlet(name = "SessionInforControl", urlPatterns = {"/sessionInfor"})
public class SessionInforControl extends HttpServlet {
...
//        s.setRoom(roomDao.getRoomById(s.getRoom().getId()));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SessionInforControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
