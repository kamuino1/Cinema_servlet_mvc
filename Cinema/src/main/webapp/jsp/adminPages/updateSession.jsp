            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-primary">
                    <div class="panel-collapse">
                        <form class="panel-body" name="command" method="post" action="updateSession">
                            <div class="row">
                                <c:set var="session" value="${requestScope.aSession}"/>
                                <c:set var="sfilm" value="${session.film}"/>
                                <c:set var="sroom" value="${session.room}"/>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" name="asession" value="${session.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <c:if test="${requestScope.room_empty}">
                                            <p class="form-error">${roomEmpty}</p>
                                        </c:if>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="time" name="time" min="${minTime}"
                                               max="${maxTime}" required autocomplete="off"
                                               value="${formattedTime}"
