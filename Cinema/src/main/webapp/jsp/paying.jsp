            ...
            <div class="col-md-12">
                <c:forEach var="ticket" items="${ticketList}">
                    ...
                    <div class="px-4 py-3 film-post card w-100">
                        ...
                        <form name="seatIdsa" method="post" action="deleteTicket">
                        <input type="hidden" name="command" value="buyTicket">
                        <input type="hidden" name="seatId" value=${seat.id}>
                        <button type="submit" class="btn btn-success w-25" style="float: right;">Xóa Ticket</button>
                    </form>
                    </div>
                ...
                <form name="seatIds" method="post" action="saveTicket">
                    <input type="hidden" name="command" value="buyTicket">
